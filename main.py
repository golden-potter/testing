...
SENDER_ADDRESS = os.environ.get("MY_SENDER")
...
def send_email(name, email, phone, message):
    ...
    with smtplib.SMTP("smtp.gmail.com") as connection:
        connection.starttls()
        connection.login(SENDER_ADDRESS, MAIL_APP_PW)
        connection.sendmail(SENDER_ADDRESS, to_addrs=MAIL_ADDRESS, msg=email_message)
